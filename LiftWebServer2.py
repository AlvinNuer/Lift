...
<a href="http://192.168.1.103:8888"><h1>Lift Web Server</h1></a>
...
<form action='http://192.168.1.103:8888/6' method='get'><input type=submit value='SPEED UP'></form>

<form action='http://192.168.1.103:8888/7' method='get'><input type=submit value='SPEED RESET'></form>

<form action='http://192.168.1.103:8888/3' method='get'><input type=submit value='EMERGENCY STOP'></form>
